...
def setup(arr):
    ...
    subprocess.call("sudo rm -rf " + pngTest_path + " && cp -r " + testout_dirPath + "/libpng-1.6.34/ " + pngTest_path, shell=True)
    ...
    subprocess.call("sudo gcov " + pngTest_path + "/*.c > " + testout_dirPath + "/gcov_output.txt", shell=True)
